...
class UserGroupsController
{
    ...
    public function index(Request $request, Response $response): Response
    {
        ...
        return view($response, 'admin/user-groups/index.php', [
    ...
    public function showForm(Request $request, Response $response, array $args): Response
    {
        ...
        return view($response, 'admin/user-groups/form.php', [
    ...
    public function save(Request $request, Response $response, array $args): Response
    {
        ...
        try {
            ...
            $_SESSION['flash_success'] = 'Groupe enregistré avec succès';
        } catch (\Exception $e) {
    ...
    public function delete(Request $request, Response $response, array $args): Response
    {
        ...
        if ($group['is_system'] ?? false) {
            $_SESSION['flash_error'] = 'Impossible de supprimer un groupe système';
            return $response->withHeader('Location', url('/admin/user-groups'))->withStatus(302);
        }
    ...
    /**
     * Met à jour les membres d'un groupe
     */
    ...
    public function apiShow(Request $request, Response $response, array $args): Response
    {
        ...
        if (!$group) {
            $response->getBody()->write(json_encode(['success' => false, 'error' => 'Groupe non trouvé']));
