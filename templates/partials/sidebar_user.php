...
<aside class="w-52 bg-white border-r border-gray-100 flex flex-col">
    ...
    <nav class="flex-1 px-2 py-3 overflow-y-auto">
        <ul class="space-y-0.5">
            ...
            <li>
                <a href="<?= url('/search') ?>" class="flex items-center px-2 py-1.5 rounded text-sm transition-colors <?= sidebarIsActive('/search', $currentRoute, $basePath) || sidebarIsActive('/chat', $currentRoute, $basePath) ? 'bg-gray-50 text-gray-900 font-medium' : 'text-gray-600 hover:bg-gray-50' ?>">
                    <svg class="w-4 h-4 mr-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="<?= url('/mes-taches') ?>" class="flex items-center justify-between px-2 py-1.5 rounded text-sm transition-colors <?= sidebarIsActive('/mes-taches', $currentRoute, $basePath) ? 'bg-gray-50 text-gray-900 font-medium' : 'text-gray-600 hover:bg-gray-50' ?>">
                    ...
                    <span class="px-1.5 py-0.5 text-xs font-medium bg-blue-100 text-blue-800 rounded-full"><?= $stats['inbox_badge'] ?></span>
                    <?php endif; ?>
                </a>
            </li>
            <li>
